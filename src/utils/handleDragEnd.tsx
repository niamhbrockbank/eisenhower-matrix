...
export default function handleDragEnd(e: MouseEvent, draggedId: number, tempItemsState :Note[], setTempItemsState : React.Dispatch<React.SetStateAction<Note[]>>, offset :Offset): void {
