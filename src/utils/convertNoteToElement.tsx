...
export default function convertNotetoElement(note: Note, tempItemsState :Note[], setTempItemsState : React.Dispatch<React.SetStateAction<Note[]>>, offset : Offset, setOffset : React.Dispatch<React.SetStateAction<Offset>>): JSX.Element { 
  return (
      <div
        key={note.id}
        className="note_div"
